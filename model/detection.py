...
modelConfiguration = "./model/yolov3-obj.cfg";
modelWeights = "./model/yolov3-obj_2400.weights";
# modelConfiguration = "./model/yolo_tiny.cfg";
# modelWeights = "./model/tiny-yolo.weights";
...
# Process inputs
def predict(frame):
    #### if local execut open it
    # winName = 'Deep learning object detection in OpenCV'
    # cv.namedWindow(winName, cv.WINDOW_NORMAL)

    # for fn in glob('../image/*.jpg'):
    # frame = cv.imread(fn)
    frame_count =0
    ...
    # line that fixed it
    _, encoded_img = cv.imencode('.PNG', frame)
